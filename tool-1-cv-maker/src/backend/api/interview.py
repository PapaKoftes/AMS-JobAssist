...
# ============================================================================
# Conversational LLM Interview (🚧 skeleton — not yet active)
# ============================================================================
...
@router.post(
    ...
    tags=["Conversational (WIP)"],
    summary="Start a conversational LLM interview (not yet implemented)",
)
async def conversational_start(request: ConversationalStartRequest) -> Dict:
    """
    🚧 Placeholder — Conversational LLM interview is not yet implemented.

    When ready this endpoint will start a free-flowing LLM-driven interview
    that adapts questions dynamically to each participant's situation.
    Until then it returns 501 so the frontend can show a coming-soon notice.
    """
    raise HTTPException(
        status_code=501,
        detail=(
            "Conversational interview mode is not yet available. "
            "Use the standard guided interview at /api/interview/start."
        ),
    )
...
@router.post(
    "/conversational/turn",
    tags=["Conversational (WIP)"],
    summary="Submit a turn in the conversational interview (not yet implemented)",
)
async def conversational_turn(request: ConversationalTurnRequest) -> Dict:
    """🚧 Placeholder — see /conversational/start."""
    raise HTTPException(status_code=501, detail="Conversational interview mode is not yet available.")
