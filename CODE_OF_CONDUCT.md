...
AMS JobAssist project a harassment-free experience for everyone, regardless
...
inclusive, and healthy community — consistent with the spirit of the
project itself, which is built to dignify people who have been let down by
job-search tooling.
...
- Focusing on what is best, not just for us as individuals, but for the
  overall community and the AMS course participants who will use this tool
...
pull requests, discussions, documentation, and any official communication
...
`conduct@ams-jobassist.example` *(placeholder — replace with the maintainer's real address before publishing)*
